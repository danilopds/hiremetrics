...
<script setup>
  ...
  const selectedCompany = ref(props.initialFilters.employer_name ?? 'all')
  ...
  const filtersChanged = computed(() => {
    ...
    if (currentFilters.employer_name !== lastFilters.employer_name) {
      console.log('Company changed:', currentFilters.employer_name, 'vs', lastFilters.employer_name)
      return true
    }

    // Check if remote changed
    if (currentFilters.job_is_remote !== lastFilters.job_is_remote) {
      console.log('Remote changed:', currentFilters.job_is_remote, 'vs', lastFilters.job_is_remote)
      return true
    }
  ...
  function onPositionChange() {
    // Reset company, remote, and seniority when position changes
  ...
  function applyFilters() {
    ...
    emit('update:filters', {
      search_position_query: selectedPosition.value,
      employer_name: selectedCompany.value !== 'all' ? selectedCompany.value : undefined,
  ...
  watch(
    ...
    (newFilters) => {
      ...
      if (newFilters.employer_name !== undefined) {
        selectedCompany.value = newFilters.employer_name
      }

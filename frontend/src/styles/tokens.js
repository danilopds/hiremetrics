 ...
 * It centralizes color definitions, spacing, typography, and other design variables.
 */

/**
 * Color Palette
 * These colors are used throughout the application and match our Tailwind configuration
 */
export const colors = {
...
export const chartColors = {
  ...
  // Categorical palette for charts with many categories
  categorical: [
    '#0284c7', // primary-600
    '#16a34a', // green-600
    '#ca8a04', // yellow-600
